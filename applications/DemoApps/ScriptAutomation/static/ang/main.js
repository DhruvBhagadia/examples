            ...
            return __generator(this, function (_a) {
                ...
                try {
                    this.dataService.getAssesments(this.finalHost, this.token).subscribe(function (assesments) {
                        ...
                        _this.http.post("/index/", JSON.stringify({ host: _this.finalHost, token: _this.token }), httpOptions).subscribe();
                    }, function (err) {
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot([
                    { path: 'app', component: _home_home_component__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"] },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.http.get("/status/").map(function (res) { return res; }).subscribe(function (response) {
                            _this.data = response;
...
module.exports = ".container {\n    padding: 10px;\n}\n\n.example-spacer {\n    flex: 1 1 auto;\n}\n\n.example-form {\n    min-width: 150px;\n    max-width: 500px;\n}\n\n.example-padding {\n    padding: 10px;\n}\n\n.example-card {\n    width: 30%;\n    margin: 15%;\n}\n\nmat-card {\n    border-radius: 8px;\n    margin-top: 15%;\n}\n\nmat-toolbar-row {\n    height: 85px !important;\n}\n\n.startButton{\n    background-color: #4562E9;\n    color: white;\n}\n\n.logoutBtn{\n    background-color: rgb(255, 153, 66);\n    position: fixed;\n    right: 1%;\n    top: 15%;\n}\n"
...
module.exports = "<div class=\"container\">\n  <div fxLayout=\"row\" fxLayout.xs=\"column\" fxLayoutGap=\"40px\" fxLayoutAlign=\"center stretch\">\n    <mat-card fxFlex=\"20%\" fxFlex.xs=\"40%\" mat-ripple class=\"mat-elevation-z6\">\n      <mat-list-item fxLayout=\"row\" fxLayoutAlign=\"center\">\n        <mat-card-content>\n          <h2>Machine</h2>\n        </mat-card-content>\n      </mat-list-item>\n      <mat-list-item fxLayout=\"row\" fxLayoutAlign=\"center\">\n        <button mat-raised-button (click)=\"selectExample('Machine')\" class=\"startButton\">\n          <strong>Start</strong>\n        </button>\n      </mat-list-item>\n    </mat-card>\n    <mat-card fxFlex=\"20%\" fxFlex.xs=\"40%\" mat-ripple class=\"mat-elevation-z6\">\n      <mat-list-item fxLayout=\"row\" fxLayoutAlign=\"center\">\n        <mat-card-content>\n          <h2>Weather</h2>\n        </mat-card-content>\n      </mat-list-item>\n      <mat-list-item fxLayout=\"row\" fxLayoutAlign=\"center\">\n        <button mat-raised-button (click)=\"selectExample('Weather')\" class=\"startButton\">\n          <strong>Start</strong>\n        </button>\n      </mat-list-item>\n    </mat-card>\n    <a href=\"/logout\"><button mat-raised-button class=\"logoutBtn\">Logout</button></a> \n  </div>\n</div>\n"
...
module.exports = __webpack_require__(/*! /home/ruturaj/Documents/examples/applications/DemoApps/FalkonryDemoExamples/src/main.ts */"./src/main.ts");
